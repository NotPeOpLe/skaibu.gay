<template>
  <div class="h-screen flex flex-col justify-center items-center bg-slate-900">
    <img src="~/assets/skaibu.png" alt="skaibu">
    <h1 class="text-3xl font-bold text-white">
      SKaiBlue
    </h1>
    <div class="flex space-x-2 text-white mt-3">
      <a class="bg-purple-700 rounded-lg px-2 py-1" href="https://www.twitch.tv/skaibu" target="_blank">
        <div class="flex pointer-events-none">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-twitch mr-1" width="24"
      ...
      <a class="flex bg-blue-500 rounded-lg px-2 py-1" href="https://twitter.com/SKaiBlue__" target="_blank">
        <div class="flex pointer-events-none">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-twitter mr-1" width="24"
            height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
            stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            <path
      ...
      <a class="flex bg-pink-500 rounded-lg px-2 py-1" href="https://osu.ppy.sh/users/579370" target="_blank">
        <div class="flex pointer-events-none">
          <svg width="300" class="mr-1 w-6 h-6" height="300" version="1.1" viewBox="0 0 300 300" stroke="currentColor"
            xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
            <path id="osu_x21__x5F_txt_x5F_Path_2_"
...
useHead({
  ...
  meta: [
    ...
    { property: "og:description", content: bullshit.generate("凱哥", 200) },
    { property: "og:url", content: "https://skaibu.gay/" },
    { property: "og:image", content: "~/assets/skaibu.png" },
